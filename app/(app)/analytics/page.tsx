    ...
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <KPICard
          ...
          icon={ArrowUpCircle}
          tone="income"
          value={formatCurrency(data.summary.income, homeCurrency)}
        />
        <KPICard
          label="Expenses"
        ...
        <KPICard
          ...
          tone={data.summary.net >= 0 ? "net-positive" : "net-negative"}
          value={`${data.summary.net >= 0 ? "+" : ""}${formatCurrency(Math.abs(data.summary.net), homeCurrency)}`}
        />
      </div>
