...
export const BUILT_IN_PROFILES: BankProfileTemplate[] = [
  ...
  },
  {
    ...
    extraMappings: JSON.stringify({
      ...
      outValues: ["OUT"],
      inValues: ["IN"],
      descriptionInColumn: "Source name",
      descriptionOutColumn: "Target name",
      descriptionFallbackColumns: ["Reference", "Source name", "Target name"],
      skipDirections: ["NEUTRAL"],
      skipTransactionIdColumn: "ID",
      skipTransactionIdPrefixes: ["BALANCE_TRANSACTION"],
